// tiptap-table-pro — styled, resizable TipTap table extensions + editing UI.
//
// Two layers:
...
// "tiptap-table-pro/core" (no React UI) if you only need the extensions.

export * from "./core";
export * from "./ui";

// i18n: wrap the editor in <TableIntlProvider> to override the default
// (Vietnamese) labels; by default strings render as-is.
